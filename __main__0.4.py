...
#print(y_C_or_D_real)
print('Acurácias')
# teria q usar os X_test q usei lá em cima pra cada caso???
print('A ou ¬A',LR_A_notA.score(X_test,y_A_notA_real))
print('B ou ¬B',LR_B_notB.score(X_test,y_B_notB_real))
print('C ou D',LR_C_or_D.score(X_test,y_C_or_D_real))
